...
namespace TestApplication.Migrations
{
    ...
    [Migration("20241122134654_RegexMigration")]
    partial class RegexMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestApplication.Models.RegexColumn", b =>
                {
                    b.HasBaseType("TestApplication.Models.ColumnInfo");
                    ...
                    b.ToTable("RegexColumns", (string)null);
                });
            ...
            modelBuilder.Entity("TestApplication.Models.RegexColumn", b =>
                {
                    b.HasOne("TestApplication.Models.ColumnInfo", null)
                        .WithOne()
                        .HasForeignKey("TestApplication.Models.RegexColumn", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
